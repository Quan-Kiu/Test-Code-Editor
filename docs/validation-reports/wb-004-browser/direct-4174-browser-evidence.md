...
Status: fail
Generated: 2026-05-23T11:46:26.549Z
Project type: game,web3d
Normal URL: http://127.0.0.1:4174
Debug URL: not_run
Browser mode: headed
Localhost direct: attempted directly; see route result
Bridge used: no
App source: real server direct
...
|---|---|---|---|---:|---|---:|---:|---:|---|---|
| player | story 960x600 | fail | not_captured | 0 | not_run | 0 | 0 | 0 | no | not_applicable |
...
- Status: fail
- Screenshot evidence path: not_captured
...
- Error: page.goto: net::ERR_BLOCKED_BY_ADMINISTRATOR at http://127.0.0.1:4174/
Call log:
  - navigating to "http://127.0.0.1:4174/", waiting until "networkidle"
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| not_captured | player | story 960x600 | TBD | TBD | not_reviewed | not_reviewed | not_reviewed | not_reviewed | not_reviewed | not_reviewed | partial | Fill human-level composition review from docs/composition-qa.md | not_run |
